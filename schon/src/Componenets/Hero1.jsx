      ...
      <div className="p-6 mt-0">
        ...
        <div className="flex flex-wrap gap-12 justify-start ml-4  md:ml-20">
          ...
          <div className="relative w-full md:w-[60%]">
            ...
            <p className="absolute bottom-70 md:bottom-76 left-8 md:left-16 text-white text-sm font-serif tracking-[0.2em] bg-black/10 px-4 py-1 rounded">
              Furniture Design ideas
            </p>
            <p className="absolute bottom-60 left-8 md:left-16 text-3xl md:text-6xl font-extrabold text-white">
              New
            </p>
            <p className="absolute bottom-48 left-8 md:left-16 text-xl md:text-4xl font-sans text-white tracking-[0.2em]">
              Collection
            </p>
            <p className="absolute bottom-36 left-8 md:left-16 w-[80%] text-xs md:text-sm font-sans text-white tracking-[0.2em]">
              Consectetur adipisicing elit. Beatae <br />
              accusamus, optio, repellendus inventore
            </p>
            <p className="absolute bottom-20 left-8 md:left-16 text-lg md:text-2xl font-extrabold font-sans text-white tracking-[0.2em]">
              $79.00
            </p>
          </div>
        ...
        <div className="flex flex-wrap gap-12 justify-start ml-4 md:ml-20">
          ...
          <div className="relative mt-6 w-full md:w-[45%]">
            ...
            <p className="absolute top-8 text-gray-400 text-lg md:text-2xl tracking-widest font-bold left-[140px] md:left-[200px]">
              ACRYLIC FABRIC
            </p>
            ...
            />
            <p className="absolute text-red-800 text-xl md:text-3xl bottom-10 left-[230px] md:left-[330px]">
              $ 99.00
            </p>
            <button className="absolute bottom-3 left-[230px] md:left-[340px] text-white bg-black hover:bg-red-800 px-2">
              Shop now
            </button>
          </div>
          ...
          <div className="relative mt-6 w-full md:w-[46%]">
            ...
            />
            <p className="absolute top-44 left-6 md:left-10 text-gray-300 line-through text-sm md:text-lg">
              $129.00
            </p>
            <p className="absolute bottom-28 left-4 md:left-8 text-xl md:text-3xl text-blue-950">
              $99.00
            </p>
